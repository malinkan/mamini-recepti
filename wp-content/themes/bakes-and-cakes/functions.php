...
function bakes_and_cakes_scripts() {
	/*$query_args = array(
		'family' => 'Open+Sans:400,400italic,700|Marck Script',
	);*/
	$query_args = array(
		//'fonts' => 'rosamunda-one-normal',
		'fonts' => 'mon-amour-one-medium',
	);
	...
	wp_enqueue_style('bakes-and-cakes-allfontsnet-fonts', add_query_arg($query_args, "http://allfont.net/allfont.css"));
